                      ...
                      child: GestureDetector(
                        onTap: () {
                          Get.toNamed('/single-property', arguments: [
                            ...
                            controller.filteredPropertiesItems[index]
                                ['description'],
                            controller.filteredPropertiesItems[index]['area'],
                            controller.filteredPropertiesItems[index]
                                ['bedrooms'],
                            controller.filteredPropertiesItems[index]
                                ['bathrooms'],
                            controller.filteredPropertiesItems[index]['floors'],
                            controller.filteredPropertiesItems[index]['rooms'],
                            controller.filteredPropertiesItems[index]
                                ['rwgasore'],
                            ...
                            controller.filteredPropertiesItems[index]
                                ['videoUrl'],
                            controller.filteredPropertiesItems[index]['id'],
                            controller.filteredPropertiesItems,
                            controller.filteredPropertiesItems[index]
                                ['createdAt'],
                            controller.filteredPropertiesItems[index]['agent'],
                          ]);
                        },
                        child: Container(
